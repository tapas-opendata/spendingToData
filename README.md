...
## 1. Як оприлюднити набір "Перелік укладених договорів" за допомогою spending.gov.ua
...
## 2. Як оприлюднити набір "Фінансова звітність" за допомогою spending.gov.ua
...
ЄДРПОУ у посиланні треба замінити на номер розпорядника в ЄДР. Наприклад, якщо номер розпорядника в ЄДР - 04051327, то посилання виглядатиме так:
...
**Таблиця 7 - Приклад паспорту набору даних на data.gov.ua**
...
**Таблиця 8 - Приклад додавання ресурсу reports**
...
Поширеною помилкою розпорядників є те, що для кожної форми звітності або для кожно періоду звітування вони створюють окремий набір даних. Цим додають собі зайвої роботи та ускладнюють роботу з даними для користувачів. Всю фінансову звітність розпорядника необхідно завантажувати в один набір даних, як різні ресурси (файли). При цьому важливо застосувати стандартний шаблон для назв ресурсів. Наприклад, підприємство, щоквартально оприлюднює форму №1 (звіт про фінансовий стан) та форму №2 (звіт про фінансові результати). Ресурси можна називати за таким шаблоном: F1-2018-Q1. Перша частина (F1) - це номер форми, друга (2018-Q1) - період звітування. Частини розділяються знаком дефіс - "-". Відповідно, ресурс за другий квартал матиме назву F1-2018-Q2, третій - F1-2018-Q3 і так далі.

**Таблиця 9 - Приклади назв ресурсів**
...
За аналогічним принципом можна розробити стандартні назви для інших форм та періодів. Приклад додавання ресурсу F2-2018-Q4 наведений у таблиці 10.

**Таблиця 10 - Приклад додавання ресурсу F2-2018-Q4**
